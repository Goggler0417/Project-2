...
## v2.08 UI/interaction fixes
- 필드 편집 레이아웃 재구성
- 필드/탭/Page/태그 머리 드래그 정렬 개선
- 선택 모드/일괄 작업 복구 및 카드 선택 지원
- 폴더를 별도 탭이 아닌 Bookmark/Profile의 folderId 기반 묶음으로 관리
- Page/Tab 제목 앞 아이콘 제거
- 태그 머리 편집 버튼 우측 정렬
- 불필요한 설명문 및 placeholder 제거
